...
function openMenu(){
  var menu = document.getElementsByClassName("HeaderLayout__subMenu")[0];
  var actualDisplay = menu.style.display;
  actualDisplay==='none'||actualDisplay===''?menu.style.display = "flex":menu.style.display ="none";
}
    ...
    <>
      <div className="HeaderLayout">
        <div className="HeaderLayout__container">
          ...
          {window.innerWidth<=425?<MenuIcon onClick={()=>{openMenu()}}/>:""}
        </div>
